...
use Concrete\Core\File\Version; // pre version 8
use Concrete\Core\Entity\File\Version as VersionEntity; // v8+
    ...
    public function action_upload()
    {
        ...
        if (!empty($_FILES)) {
            foreach($_FILES as $file) {
                ...
                if (!($r instanceof Version) && !($r instanceof VersionEntity)) {
