...
if ($akSelectAllowOtherValues) {
    ...
    */
    echo (string) new Element(
        'span',
        $form->selectMultiple($view->field('atSelectOptionValue'), $controller->getOptions(), count($selectedOptionIDs) ? $selectedOptionIDs : '', ['class' => 'form-control', 'data-select-and-add' => $akID]),
        [
